...
class ViewVitalSign(unittest.TestCase):

    def setUp(self):
        Baseconfig.driver.get(Configuration.BASE_URL)

        
    def test_viewvitalsign(self):

        actual_url='http://0.0.0.0:8000/patient_records/patient-vital-sign-view/923412347235'
        ...
        vitalsignview= Baseconfig.driver.find_element_by_xpath('/html/body/div[2]/div/section[2]/div/div/div/div/ul/li[3]/a')
        Baseconfig.driver.execute_script("arguments[0].click();", vitalsignview)
