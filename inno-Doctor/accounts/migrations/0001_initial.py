# Generated by Django 2.2.24 on 2022-01-13 05:10
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('eprescription', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='accounts.EPrescription')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dose_interval', models.CharField(blank=True, max_length=100, null=True)),
                ('dose_specific_timing', models.TimeField()),
                ('medication_order', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='accounts.MedicationOrder')),
            ],
        ),
    ]
