...
class PatientTest(unittest.TestCase):
    ...
    # click on sign in
       ...
       # put id in box
        ...
        # Enter_box=selenium.find_element_by_name("aadhaarId").send_keys(Aadharkey)
        # wait.until(EC.presence_of_element_located((By.NAME, "aadhaarId"))).send_keys(Aadharkey)
        # wait.until(EC.presence_of_element_located((By.NAME,"aadhaarId"))).send_keys(Keys.ENTER)
