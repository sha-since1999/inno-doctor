...
class PatientTest(unittest.TestCase):
    ...
    # click on sign in
        ...
        actual_url="http://127.0.0.1:8000/patient_records/patient-eprescription/923412347234"

# To Check Medication Statements
        Submitbutton=selenium.find_element_by_css_selector("body > div.card.card-body.blur.shadow-blur.mx-3.mx-md-4.mt-n6 > div > section:nth-child(4) > div > div > div > div > ul > li:nth-child(1) > a")
