...
class Patient(models.Model):
    ...
    aadhaarId = models.CharField(
        primary_key = True, max_length = 12,
        help_text = "patient aadhaar no | 12 digit"
        )
    name = models.CharField(max_length = 20, help_text = "patient aadhaar")
    date_of_birth = models.DateField(
        max_length = 8, help_text = "patient date of birth"
        )
    gender = models.CharField(
        choices = GENDER_CHOICES, help_text = "pateint gender", max_length = 1
        )
...
class ProblemList(models.Model):
    ...
    severity = models.CharField(
        max_length = 20, choices = SEVERITY, default = None
        )
...
class MedicationStatement(models.Model):
    ...
    description = models.TextField(
        null = True, help_text = "give a short description!"
        )
...
class MedicationItem(models.Model):
    medication_statement = models.ForeignKey(
        MedicationStatement, on_delete = models.CASCADE
        )
    medication_item = models.CharField(
