...
def PatientList(request):
    ...
    Patient.objects.filter(date_of_birth = date_of_birth).exists()):
        ...
        return redirect(request, "patient_records/patient_record_form.html")
...
#         print("success")
#     except:
#         messages.error(request, 'failed to open new medicaiton Statement
#         form')
#         return  redirect('/patient_records/patient-detail/{}'.format(id))
#         # model.instance
#     if request.method == "POST":
#         form =MedicationItemForm( request.POST, initial={
#         'medication_statement':new_medication_statement_obj})
#         if form.is_valid():
#             try:
#                 form.save()
#                 messages.success(request, 'New Medication statement is
#                 successfully added.!')
#             except:
#                 messages.error(request, 'failed to Add New medicaiton
#                 Statement list')
#             return  redirect('/patient_records/patient-detail/{}'.format(id))
#     else :
#         form=MedicationItemForm( initial={
#         'medication_statement':new_medication_statement_obj})
#     return render(request,'patient_records/patient-medication-item.html',
#     {'form':form,'patient' :patient})
